...
const HomeDesktop: React.FC<HomeLayoutProps> = ({
  player,
  activeTome,
  activeEncounter,
  visibleEncounter,
          ...
          <div className="w-full h-full overflow-y-auto custom-scrollbar flex flex-col items-center py-12 px-6">
             <div className="w-full max-w-6xl flex flex-col">
                <div className="text-center mt-4 mb-4 flex-shrink-0 z-10 w-full">
                    <h1 className="text-7xl font-serif font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-500 via-parchment-200 to-amber-500 mb-4 drop-shadow-md">
                    {t.titles.home}
                    </h1>
